  ...
  methods: {
    fetchTasks() {
      ...
      this.tasks = [
        ...
        {
          name: 'Java Coding Assignment Solution',
          category: 'DL',
          dueDate: '2025-02-19',
          completed: false,
        },
        ...
        {
          name: 'Complete Tasks Assigned by Instructor',
          category: 'DL',
          dueDate: '2025-02-25',
          completed: false,
        },
        { name: 'Resolve Queries', category: 'SWT', dueDate: '2025-02-26', completed: false },
